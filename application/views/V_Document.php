    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- Page Heading -->
				<h4 class="box-title"><i class="fa fa-table" aria-hidden="true"></i> Document </h4>
                ...
                <div class="card shadow mb-4">
                    <div class="card-body">
						...
						<?php } ?>
                        <a href="<?=site_url('document/form_insert_document')?>" style="margin-bottom:10px;" type="button"
                    ...
                    <div class="">
								<table class="display" id="dataTable">
									...
									<tbody>
										<tr>
                                            <?php if(is_array($list_document_project)){?>
                                            ...
                                            <td><a type="button" class="btn btn-info"
													href="<?=site_url('document/documentViewUpdate/'.$item->id_project)?>"
	...
	<div class="modal fade" id="deleteModal<?=$dd->id_project;?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<form action="<?=site_url('document/DeleteData/'.$dd->id_project)?>">
