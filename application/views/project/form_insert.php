			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div class="card shadow mb-4">
						...
						<!-- Card Body -->
						<div class="card-body">
							<form action="<?= site_url('project/SaveData')?>" method="post" enctype="multipart/form-data">
								...
								<div class="row">
                                    ...
                                    <div class="col-6">
										<div class="form-group">
                                            ...
                                            <input type="radio" name="status" value="Tender" style="margin-left:15%">
                                            <label for="tender">Tender</label>
                                            <input type="radio" name="status" value="Project" style="margin-left:15%">
