			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div class="card shadow mb-4">
						...
						<!-- Card Body -->
						<div class="card-body">
							<form action="<?= site_url('document/SaveData')?>" method="post" enctype="multipart/form-data">
								...
								<div class="row">
									<div class="col-6">
										<div class="form-group">
                                            ...
                                            style="margin-left:10%;width:50%;display:inline;">
												...
												<?php foreach($list_project as $s){ ?>
												<option value="<?=$s->id_project?>"><?=$s->id_project?></option>
												<?php } ?>
											</select>
										</div>
									</div>
                                    ...
                                    <div class="col-6">
										<div class="form-group">
											<label for="fileproject">Upload File Project</label>
                                            <input type="file" name="fileproject" class="form-control"
                                                   style="margin-left:5%;width:70%;display:inline;"
                                                   id="fileproject" multiple>
										</div>
									</div>
								</div>
								<!-- /.box-body -->
