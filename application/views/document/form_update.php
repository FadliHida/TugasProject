			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div class="card shadow mb-4">
						...
						<!-- Card Body -->
						<div class="card-body">
							<form action="<?= site_url('document/UpdateData')?>" method="post" enctype="multipart/form-data">
								<!-- Columns are always 50% wide, on mobile and desktop -->
								<div class="row">
                                  <?php foreach($data_list_project as $item){ ?>
									<div class="col-6">
									...
									<div class="col-6">
										<div class="form-group">
											...
											<input type="text" name="nama_project" value="<?= $item->nama_project?>"
												style="margin-left:10%;width:50%;display:inline;"
												class="form-control form_datetime" placeholder="Nama Project">
										</div>
									</div>
                                    ...
                                    <div class="col-6">
										<div class="form-group">
											...
											<input type="text" name="departement" value="<?= $item->departement?>"
												style="margin-left:5%;width:50%;display:inline;"
												class="form-control form_datetime" placeholder="Departement">
										</div>
									</div>
                                    ...
                                    <div class="col-6">
										<div class="form-group">
											...
											<input type="text" name="industri" value="<?= $item->industri?>"
												style="margin-left:19%;width:50%;display:inline;"
												class="form-control form_datetime" placeholder="Industri">
										</div>
									</div>
                                    ...
                                    <div class="col-6">
										<div class="form-group">
											...
											<input type="text" name="type" value="<?= $item->id_project?>"
												style="margin-left:17%;width:50%;display:inline;"
									...
									<div class="col-6">
										<div class="form-group">
											...
											<input type="text" name="asset" value="<?= $item->asset?>"
												style="margin-left:22%;width:50%;display:inline;"
												class="form-control form_datetime" placeholder="Asset">
										</div>
									</div>
                                    <div class="col-6">
										<div class="form-group">
											<label for="status">Status</label>
                                            <input type="radio" name="status" <?= ($item->status =='Tender')?'checked':'' ?> value="Tender" style="margin-left:15%">
                                            <label for="tender">Tender</label>
                                            <input type="radio" name="status" <?= ($item->status =='Project')?'checked':'' ?> value="Project" style="margin-left:15%">
									...
									<div class="col-6">
										<div class="form-group">
											...
											<input type="text" name="lokasi" value="<?= $item->lokasi?>"
												style="margin-left:21%;width:50%;display:inline;"
												class="form-control form_datetime" placeholder="Lokasi">
										</div>
									</div>
                                    <div class="col-6">
										<div class="form-group">
